...
public class ImageFileCompressUtil {
    ...
    public static File compressFile(String oldpath, String newPath) {
        Bitmap compressBitmap = ImageFileCompressUtil.decodeFile(oldpath);
        ...
        File file = null ;
        try {
            file = ImageFileCompressUtil.getFileFromBytes(bytes, newPath);
        } catch (Exception e) {
            e.printStackTrace();
        }finally{
            if(newBitmap != null ){
    ...
    public static Bitmap decodeFile(String fPath) {
        ...
        int scale = 1;
        final int REQUIRED_SIZE = 200; //压缩到200KB
